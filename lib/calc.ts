...
//
// Chegara aniqligi: veneks-safety_report.pdf va 21512.pdf (ikkalasi ham
// mustaqil, haqiqiy sanoat CPSR hisobotlari) so'zma-so'z "MoS is >100" /
// "must be greater than 100" deb yozadi — qat'iy "dan katta", "dan katta
// yoki teng" emas. Shu ikkala real namunaga mos qat'iy `>` ishlatiladi.
